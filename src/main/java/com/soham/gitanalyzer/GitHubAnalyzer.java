...
public class GitHubAnalyzer {
	...
	public List<RepositoryContents> getContents(Repository repository, String path, String reference) {
	    ...
	    try {
            ...
            System.err.println("Contents for repository "+ repository.getName() +" for tag/branch "
                    + reference +" on path "+ ((path == null)? "root" : path) +" could not be found.");
            ioex.printStackTrace();
        }
	    return contents;
	}
	
	public List<String> notContainsFile(Repository repository, List<String> references, String path,
	        String fileName) {
	...
	public void analyze() {
		...
		if(repository != null){
			...
			if((branchNamesNotHavingFile == null) || (0 == branchNamesNotHavingFile.size())) {
			    System.out.println("====================================");
                System.out.println("All the branches in repository "+ repository.getName() +
                        " have the file "+ fileNotContains);
			} else {
			    System.out.println("====================================");
			...
			if((tagNamesNotHavingFile == null) || (0 == tagNamesNotHavingFile.size())) {
                System.out.println("====================================");
                System.out.println("All the tags in repository "+ repository.getName() +
                        " have the file "+ fileNotContains);
            } else {
                System.out.println("====================================");
